...
class TestIntentManager:
    ...
    def test_detect_intent_get_smells(self, mocker, intent_manager_instance):
        ...
        intent, entities, confidence,_ = intent_manager_instance.detect_intent("can you get community smells for this repo https://github.com/tensorflow/ranking")
    ...
    def test_detect_intent_get_smells_date(self, mocker, intent_manager_instance):
        ...
        intent, entities, confidence,_ = intent_manager_instance.detect_intent("can you get community smells for this repo https://github.com/tensorflow/ranking from 2022/01/01")
